...
public class LoginForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jp.setBackground(new java.awt.Color(108, 122, 137));
        jp.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jp.setForeground(new java.awt.Color(228, 241, 254));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(107, 107, 107)
                        .addComponent(jLabelRegister, javax.swing.GroupLayout.PREFERRED_SIZE, 176, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String pas=String.valueOf(jp.getPassword());

        String querry="SELECT * FROM `perdorus` WHERE `Emer`=? AND `Password`=? ";

        try {
            ps=log.getConnection().prepareStatement(querry);
            ps.setString(1,emri);
            ps.setString(2,pas);
            rs=ps.executeQuery();
            if(rs.next()){
